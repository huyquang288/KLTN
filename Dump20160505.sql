...
INSERT INTO `account_user` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6);
...
INSERT INTO `bookmark` VALUES (13,1,2);
...
INSERT INTO `group_group` VALUES (1,1,2),(2,1,3),(3,2,3),(4,5,3),(5,1,4),(6,1,5),(7,1,6),(8,1,7),(10,1,9),(13,2,7),(14,1,10),(15,10,1);
...
INSERT INTO `group_user` VALUES (1,1,1,1),(2,1,2,0),(3,2,1,1),(4,3,1,1),(6,5,3,1),(7,2,4,0),(8,6,2,1),(9,3,2,0),(18,1,5,0),(19,2,6,0),(20,4,6,0),(37,6,2,0),(38,7,3,0),(40,9,1,1),(44,9,5,0),(45,3,4,0),(46,3,5,0),(47,10,4,0),(48,10,5,0),(49,10,1,1);
...
INSERT INTO `groups` VALUES (1,'SGUET','UET support group'),(2,'K57C','UET K57 IT\'s group'),(3,'K57CLC','K57CLC\'s group'),(4,'K57CA','K57CA\'s group'),(5,'K57CB','K57CB\'s group'),(6,'K57CD','K57CD\'s group'),(7,'K57T','K57T\'s group'),(9,'BM HTTT','HTTT\'s group'),(10,'SMART OSC',NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `messenger_developer`.`groups_AFTER_INSERT` AFTER INSERT ON `groups` FOR EACH ROW
BEGIN
	INSERT INTO group_group (firstGroupId, secondGroupId) VALUES (1, new.id);
END */;;
DELIMITER ;
...
INSERT INTO `topicchats` VALUES (1,1,'img/icon/male.jpg','xin chào tất cả mọi người :D',1,'2016-04-10T13:39:48.810Z'),(2,2,'img/icon/female.jpg','chào huy quang',1,'2016-04-10T18:34:57.045Z'),(3,1,'img/icon/male.jpg','chào bạn, bạn có thể gửi cho mình tài liệu môn CTDL không?',1,'2016-04-10T18:35:20.759Z'),(4,1,'img/icon/male.jpg','bạn muốn xin bài giảng hay bài tập',1,'2016-04-10T18:40:52.432Z'),(5,2,'img/icon/female.jpg','mình muốn xin cả 2',1,'2016-04-10T18:41:03.621Z'),(6,2,'img/icon/female.jpg','bạn gửi vào email cho mình nhé.',1,'2016-04-10T18:55:34.906Z'),(9,1,'img/icon/male.jpg','lớp mình ra trường các bạn có dự định phỏng vấn vào viettel không?',4,'2016-04-12T16:44:36.632Z'),(10,2,'img/icon/female.jpg','có, mình cũng có ý định đi phỏng vấn :D',4,'2016-04-14T16:40:02.378Z'),(11,1,'img/icon/male.jpg','cậu ôn được nhiều chưa?',4,'2016-04-14T16:40:53.305Z'),(12,2,'img/icon/female.jpg','mình mới được chút tiếng anh thôi. hì hì',4,'2016-04-14T16:42:10.097Z'),(13,1,'img/icon/male.jpg','bên đó yêu cầu nhiều quá không biết có kịp ôn hết không ~~',4,'2016-04-14T16:44:52.044Z'),(14,2,'img/icon/female.jpg','thời gian phỏng vẫn cũng dài mà',4,'2016-04-14T16:46:44.169Z'),(15,1,'img/icon/male.jpg','Ok bạn',1,'2016-05-01T10:40:44.933Z');
...
INSERT INTO `topics` VALUES (1,1,1,NULL,'Tài liệu ôn thi cuối kì'),(2,2,1,NULL,'Chuẩn bị tốt nghiệp'),(3,4,1,NULL,'Báo cáo nghiên cứu khoa học'),(4,3,0,NULL,'Phỏng vấn xin việc'),(5,9,1,NULL,'Database topic'),(6,1,0,NULL,'Trao đổi ôn thi cuối kì'),(8,1,0,'','Ngày hội việc làm'),(9,3,1,'','Nộp báo cáo niên luận');
...
INSERT INTO `users` VALUES (1,'Huy','Quang',0,'img/icon/male.jpg'),(2,'Hoa','Phương',1,'img/icon/female.jpg'),(3,'Hoàn','Trần',0,'img/icon/male.jpg'),(4,'Hưng','Lùn',0,'img/icon/male.jpg'),(5,'Ngọc','Bảo',1,'img/icon/female.jpg'),(6,'Học','buffalo',0,'img/icon/male.jpg');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'messenger_developer'
--

--
-- Dumping routines for database 'messenger_developer'
--
...
-- Dump completed on 2016-05-05 23:33:07
